...
**Valid values:** `Enum.WrapTargetDebugMode.None`, `Enum.WrapTargetDebugMode.TargetCageOriginal`, `Enum.WrapTargetDebugMode.TargetCageCompressed`, `Enum.WrapTargetDebugMode.TargetCageInterface`, `Enum.WrapTargetDebugMode.TargetLayerCageOriginal`, `Enum.WrapTargetDebugMode.TargetLayerCageCompressed`, `Enum.WrapTargetDebugMode.TargetLayerInterface`, `Enum.WrapTargetDebugMode.Rbf`, `Enum.WrapTargetDebugMode.OuterCageDetail`, `Enum.WrapTargetDebugMode.PreWrapDeformerCage`
