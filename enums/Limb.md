...
| `Unknown` | 6 |  | If a part is not a limb (e.g. running the `Class.Humanoid:GetLimb()` function and passing it an accessory which is a sibling of the Humanoid will return this value). |

**Valid values:** `Enum.Limb.Head`, `Enum.Limb.Torso`, `Enum.Limb.LeftArm`, `Enum.Limb.RightArm`, `Enum.Limb.LeftLeg`, `Enum.Limb.RightLeg`, `Enum.Limb.Unknown`
